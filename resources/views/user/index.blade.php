...
<div class="container">
    @if($errors->any())
        <div class="alter alert-danger">
                <button type="button" class="close" data-dismiss="'alert" aria-hidden="'true">&items;</button>
                <ul>
            ...
            <div class="panel-body">
                <form action="{{route('user.add')}}" method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="username"  class="form-control" value="" title=""
                                   required="required">
                        </div>
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email"  class="form-control" value="" title=""
                                   required="required">
                        </div>
